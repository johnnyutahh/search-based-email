...
DISCLAIMER: this document may be in flux as I learn this domain.
...
The tag-based-classification paradigm seems _significantly_
...
* While I may be be moving to a a tag-based paradigm, I still need to
  access
