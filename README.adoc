...
1. Initial tests show
   ...
   ** 2015-07-13 Update: mu employs a .noupdate feature designed to
      mitigate this problem. I'm invesitgating if Notmuch does something
   ...
   *** http://notmuchmail.org/pipermail/notmuch/2015/020755.html[Any
       related (to mu's .noupdate) Notmuch feature?]
