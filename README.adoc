...
3. #1 greatly outweighs #2. Because of this, notmuch "wins."
...
Since notmuch <<Choosing,won>>, the following outlines a notmuch-specific
implementation/tools/etc.

### email-to-maildir gathering: mbsync [solved]

* http://isync.sourceforge.net/[mbsync]
