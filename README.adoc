...
* Historically trained as software+systems engineer
* Experience with variety of programming languages and OSes: C, C\++,
  Java, Ada, perl, Python; Windows, Unix, Linux, VMS, MacOSX
