...
. *Near-term*. I'm seeking significant and timely feedback on this
document from the <<core_choice,Notmuch, mu, and related user
communities>>.
...
* Any written feedback works: email-list replies,
  ...
  git forks-plus-pull-requests, etc. Let me know if you'd like write
  access to https://github.com/johnnyutahh/tag-based-email[the repo].
...
** I searched for a similar web resource to comprehensively introduce me
   ...
   I couldn't find anything>>. Please advise if something should be
   included that's not already referenced here.
...
options for the remainder of the tool choices may be
