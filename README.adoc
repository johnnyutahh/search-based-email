...
. Near-term: it hopefully provides the best chance for an efficient and
  successful transition, if the <<core_choice,Notmuch and mu user
...
*** Please provide feedback whichever way you prefer. Email-list replies
    to point topics are great. Git forks and pull's also great, and
    easier for me, but (obviously) not required. I can also possibly
    provide write access to this repo, upon request.
