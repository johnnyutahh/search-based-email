...
** Among other things, moving _and_ copying emails to a variety of IMAP
   folders--in order to "classify" said emails--gets cumbersome.
...
*** first: http://stackoverflow.com/a/6725161/605356[overcame lack
...
* While I may be be moving to a a tag-based paradigm, I
  ...
  <<folder_based_searching,folder-based>> to a tag-based paradigm.
  Any primary MUA/interface/IMAP-client I choose needs to support
  IMAP-folder-based paradigms (copying and moving to folders, etc) that
  I currently employ with <<the_problem,Mozilla Thunderbird>>.
