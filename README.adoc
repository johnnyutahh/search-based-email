...
2. to leverage tag-based categorization, and
3. integrate with external-to-MUA text-processing tools - namely ones
   me+my team have developed.
...
* Some might describe me as an impatient, unforgiving computing
  ...
  this.) And this drives me nuts. I end up talking to the computer:
  "Computer, if you need more time to complete a job, don't lie to me.
  I can go do other things while I wait for you. Just don't make me
  further wait when you already said you were done."
 
* In summary, I'm a vim and Python lover, a keyboard jockey, and a
  fairly-technical, impatient, demanding user. Who gets lots of email.
