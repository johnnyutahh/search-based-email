...
and https://github.com/pazz/alot[alot] are being actively investigated.
However, I've not yet settled on a primary MUA. Along with
<<initial_tagging>>, this (<<MUA_setup>>) appears to represent the
